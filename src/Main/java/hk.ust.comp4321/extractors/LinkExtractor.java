...
public class LinkExtractor {
    ...
    public static List<WebNode> extractLinks(IndexTable invertedIndex, String rootURL, int numPages) throws IOException {
        // TODO: return a list of WebNode objects using bfs, each of which represents a webpage.
        // The id can be obtained by calling invertedIndex.getNewPageId().
        // Need to update id2WebNode and url2Id in the invertedIndex when adding a new WebNode.
        // Note the id will increase by 1 for each new page when calling invertedIndex.addEntry().
        // ADD YOUR CODES HERE
