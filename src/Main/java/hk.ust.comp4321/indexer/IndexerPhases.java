...
public class IndexerPhases {
    ...
    public void indexPhases(String url) throws Exception {
        // Index the title
        indexTitle(url);
        indexBody(url);
    }

    public void indexTitle(String url) throws Exception {
...
//            counter++;
        ...
        for (int i = 0; i < pos.size(); i++) {
            ...
            if (start == end) {
                ...
                ArrayList<String> phrases = findAllPhrases(phrase);
...
//         6. Insert the wordIdTitle and id into the forward index
    ...
    ArrayList<String> findAllPhrases(String[] phrase) {
        ArrayList<String> phrases = new ArrayList<>();
        for(int i = 2; i <= phrase.length; i++){// length allowed
